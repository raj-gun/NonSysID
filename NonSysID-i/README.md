...
The following `NonSysID` functions are called directly by the NonSysID-i functions and must therefore be available on the MATLAB path (e.g. addpath('\<path-to-NonSysID\>') can be used):
