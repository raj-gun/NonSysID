...
u = 0.6 .* (2.*rand(n, 1) - 1); % Random input signal, u(t) ~ U(-0.6,0.6), keeps the model stable
y = mao_piroddi_ar_nfir_model(n, u, e); % Simulate the AR-NFIR NARX model
