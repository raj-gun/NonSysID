function [theta,X_main,trm_chsn_lin,trm_chsn_lin_org,n_lin_trms_org,trm_lag_char_lin_incld,trm_chsn_nl,trm_lag_char_tot,...
    ...
    = Sys_ID_iOFRs_PRESS_AR_NFIR(RCT,mod_type,U_delay_mat,k,X,Y,Y_sim,Sim_ini_val,min_dyn_ord_u,max_dyn_ord_u,min_dyn_ord_y,max_dyn_ord_y,nl_ord_AR,nl_ord_NFIR,is_bias,inpt0,stp_cri,alph,D1_thresh,displ,x_iOFR,parall)
%#codegen
%% Initialisation
warning('off');
...
if nl_ord_max >= 2    
    ...
    [trm_lag_char_tot, X_main_org, trm_chsn_lin_org, trm_chsn_lin, n_lin_trms_org, n_lin_trms, trm_chsn_nl, n_nl_trms, trms]...
        = RCT_sel_AR_NFIR(RCT, trm_lag_char_lin_incld, X_main, trm_chsn_lin_org, trm_chsn_lin, n_lin_trms_org, n_lin_trms, nl_ord_max, trm_lag_char_lin, X, Y, alph, is_bias, dat_len, nl_ord_AR, nl_ord_NFIR);
    % ----------------------------------------------------------------------------
