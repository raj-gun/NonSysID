function [model, Mod_Val_dat, iOFR_table_lin, iOFR_table_nl, best_mod_ind_lin, best_mod_ind_nl, val_stats] = NonSysID_AR_NFIR(mod_type,u,y,a1,a2,b1,b2,nl_ord_AR,nl_ord_NFIR,is_bias,n_inpts,KSA_h,RCT,x_iOFR,stp_cri,D1_thresh,displ,sim,parall)

%% Form the linear regressors/monomials/lagged-terms/model terms
nl_ord_max = max(nl_ord_AR,nl_ord_NFIR); % Max. polynomial order of the full candidate dictionary
...
[theta,~,trm_chsn_lin,trm_chsn_lin_org,n_lin_trms_org,~,trm_chsn_nl,~,iOFR_table_lin,iOFR_table_nl,ERR_table_lin,ERR_table_nl,best_mod_ind_lin,best_mod_ind_nl,Mod_Val_dat]...
    = Sys_ID_iOFRs_PRESS_AR_NFIR(RCT,mod_type,U_delay_mat_simID,KSA_h,X_ID,Y_ID,Y_simID,Sim_ini_valID,min_dyn_ord_u,max_dyn_ord_u,min_dyn_ord_y,max_dyn_ord_y,nl_ord_AR,nl_ord_NFIR,is_bias,inpt0,stp_cri,5,D1_thresh,displ,x_iOFR,parall);
