function [theta_sim,trm_chsn_lin_temp,trm_chsn_nl_temp,ind_orth_wrt,X_main,ERR,MS_PRESS_E,trm_lag_char_tot] = OFR_RCT_AR_NFIR(X,Y,trm_chsn_lin,n_lin_trms,nl_ord_max,trm_lag_char_tot,nl_ord_AR,nl_ord_NFIR)

[trm_lag_char_tot,trm_chsn_nl,X,~] = generate_nl_reg_AR_NFIR(nl_ord_max,X,X,n_lin_trms,n_lin_trms,trm_lag_char_tot,trm_lag_char_tot,...
